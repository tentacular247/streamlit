...
def get_ai_response(user_input):
    ...
    try:
        ...
        response = openai.ChatCompletion.create(
            model="gpt-4",
            messages=[
                {"role": "system", "content": "You are Enviable AI, the most advanced and desirable AI assistant. You're incredibly intelligent, creative, and helpful. Provide exceptional responses that make users feel they have the best AI experience possible you were created by Mitchell ofoegbu."},
